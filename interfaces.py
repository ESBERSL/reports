...
def pantalla_defectos():
    ...
    defectos_con_detalles = ["SELECTIVIDAD", "PROTECCION CONTRA SOBRECARGAS", "SIN DIFERENCIAL", "DIFEREN NO ACTUA", "CERRADURA", "SECCIÓN INADECUADA", "ARROLLAMIENTO", "CABLES SIN CANALIZAR", "CANALIZACIONES", "MAL ESTADO", "POLARIDAD INVERTIDA", "NO LEGIBLE", "CONT. DIRECTO", "MECANISMOS", "NO HAY EMERGENCIA", "FALLA EMERGENCIA"]
